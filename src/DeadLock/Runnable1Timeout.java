...
public class Runnable1Timeout implements Runnable {
        ...
        while (true){
            ...
            while (! tryLockBothLocks()){
                ...
                System.err.println(threadName + "failed to lock both Locks."+
                        "Waiting abit before retrying [" + failureCount + "tries]");
    ...
    private boolean sleep(long timeMillis) {
        try {
     ...
     private boolean tryLockBothLocks(){
        ...
        try {
            ...
            System.out.println(threadName + "interrputed trying to lock Lock 1");
            return  false;
        }
      ...
      try {
        ...
        if(!lock2Succeeded){
          ...
          System.out.println( threadName + "interrputed trying to lock Lock 2");
        lock1.unlock();
        return  false;
    }
      return true;
